...
var AppointmentsRepository_1 = __importDefault(
  require('../repositories/AppointmentsRepository'),
);
var CreateAppointmentService_1 = __importDefault(
  require('../services/CreateAppointmentService'),
);
var ensureAuthenticated_1 = __importDefault(
...
appointmentRouter.get('/', function (request, response) {
  return __awaiter(void 0, void 0, void 0, function () {
    var appointmentsRepository, appointments;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          appointmentsRepository = typeorm_1.getCustomRepository(
            AppointmentsRepository_1.default,
          );
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          ...
          createAppointmentRepository = new CreateAppointmentService_1.default();
          return [
            4 /*yield*/,
