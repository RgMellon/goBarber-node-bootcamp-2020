    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                userService = new CreateUserService_1.default();
                return [4 /*yield*/, userService.execute({ email: email, name: name, password: password })];
            case 1:
                user = _b.sent();
...
userRouter.patch('/avatar', ensureAuthenticated_1.default, upload.single('avatar'), function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var updateAvatarSerice, user;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                updateAvatarSerice = new UpdateUserAvatarService_1.default();
                return [4 /*yield*/, updateAvatarSerice.execute({
